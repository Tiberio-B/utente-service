...
public class UtenteMapper implements Mapper<Utente, UtenteDto> {
    ...
    public Utente mapDtoToEntityImpl(UtenteDto dto) throws RuntimeException {
        return Utente.builder()
                ...
                .flagAbilitazione(FlagSN.valueOf(dto.getAbilitato()))
                .dataInizio(LocalDate.parse(dto.getDataInizioValidita()))
                .dataFine(LocalDate.parse(dto.getDataFineValidita()))
                .ruolo(Ruolo.builder()
                        .id(Long.parseLong(dto.getRuoloId()))
                        .build())
                .rts(Rts.builder()
    ...
    public UtenteDto mapEntityToDtoImpl(Utente entity) {
        return UtenteDto.builder()
                ...
                .nome(entity.getNome())
                .cognome(entity.getNome())
                .abilitato(String.valueOf(entity.getFlagAbilitazione()))
                .ruoloId(String.valueOf(entity.getRuolo()
                        .getId()))
                .rtsId(String.valueOf(entity.getRts()
                        .getId()))
                .build();
    }
